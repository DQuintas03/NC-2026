...
export const KPICard = ({ label, value, change, trend, icon, index = 0 }) => {
  ...
  return (
    <div
      ...
      className={`bg-white rounded-lg border border-slate-200 shadow-sm p-6 flex flex-col justify-between hover:shadow-md transition-shadow duration-200 animate-fade-in-up animate-delay-${index * 100}`}
    ...
    >
      ...
      <div>
        <p className="text-4xl font-bold tracking-tighter text-[#017cb7] font-['Outfit']">
          {value}
        </p>
